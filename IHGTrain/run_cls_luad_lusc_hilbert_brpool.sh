#!/bin/bash
# ==============================================================================
# IHG-Mamba Classification: LUAD_LUSC Hilbert Boundary-Residual Pool
# - Hilbert-ordered features (already reordered)
# - ATP-Pool with residual mode (boundary residual pooling)
# - gamma_init=0.05, tau_init=2.0, K_init=2.5, norm_type=mean
# ==============================================================================
...
# ---- Results ----
EXP_CODE="cls_luad_lusc_hilbert_brpool"
RESULTS_DIR="./experiments/classification/${TASK}"

echo "============================================================"
echo " IHG-Mamba Classification: LUAD_LUSC Hilbert BR-Pool"
echo "============================================================"
echo " data_root_dir: ${DATA_ROOT_DIR}"
echo " feature_subdir: ${FEATURE_SUBDIR} (already Hilbert ordered)"
echo " pool_mode: ${POOL_MODE} (gamma_init=${GAMMA_INIT}, tau_init=${TAU_INIT})"
echo "============================================================"
