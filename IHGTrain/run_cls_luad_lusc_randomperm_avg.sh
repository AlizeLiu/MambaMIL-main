#!/bin/bash
# ==============================================================================
# IHG-Mamba Classification: LUAD_LUSC Random Perm + Avg Pool
# - Hilbert-ordered features (already reordered), then shuffled (negative control)
# - ATP-Pool with avg mode
# - order_mode=random_perm, order_seed=1
# ==============================================================================
...
# ---- Results ----
EXP_CODE="cls_luad_lusc_randomperm_avg"
RESULTS_DIR="./experiments/classification/${TASK}"

echo "============================================================"
echo " IHG-Mamba Classification: LUAD_LUSC Random Perm + Avg Pool"
echo "============================================================"
echo " data_root_dir: ${DATA_ROOT_DIR}"
echo " feature_subdir: ${FEATURE_SUBDIR} (already Hilbert ordered)"
echo " order_mode: ${ORDER_MODE} (order_seed=${ORDER_SEED})"
